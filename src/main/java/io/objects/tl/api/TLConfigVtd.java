 ...
 */
public class TLConfigVtd extends TLObject {
    public static final int CONSTRUCTOR_ID = 0xe6ca25f6;
    ...
    private final String _constructor = "configVtd#e6ca25f6";

    public TLConfigVtd() {
    }

    public TLConfigVtd(boolean phonecallsEnabled, boolean defaultP2pContacts,
                       ...
                       int megagroupSizeMax, Integer baseLangPackVersion, int forwardedCountMax, int onlineUpdatePeriodMs,
                       ...
                       int callConnectTimeoutMs, boolean pfsEnabled, int callPacketTimeoutMs, String meUrlPrefix,
    ...
    public int computeSerializedSize() {
      ...
      /*  if ((flags & 4) != 0) {
        ...
        if ((flags & 4) != 0) {
            if (baseLangPackVersion == null) throwNullFieldException("langPackVersion", flags);
            size += SIZE_INT32;
        }*/
        return size;
    }
    ...
    public void setMaxChatSize(int maxChatSize) {
    ...
    public boolean isPreloadFeaturedStickers() {
        return preloadFeaturedStickers;
    }
