...
public class TLChannelFull extends TLAbsChatFull {
    public static final int CONSTRUCTOR_ID = 0x76af5481;
    ...
    private final String _constructor = "channelFull#76af5481";

    public TLChannelFull() {
    }

    public TLChannelFull(boolean canViewParticipants, boolean canSetUsername,
