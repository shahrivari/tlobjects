 ...
 */
public class TLInputDocumentLocationVtd extends TLAbsInputFileLocation {
    ...
    private final String _constructor = "inputPhotoVtd#bad07584";

    public TLInputDocumentLocationVtd() {
    }

    public TLInputDocumentLocationVtd(long id, long accessHash, TLBytes fileReference) {
        this.id = id;
