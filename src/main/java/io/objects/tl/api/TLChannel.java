...
public class TLChannel extends TLAbsChat {
    public static final int CONSTRUCTOR_ID = 0xc88974ac;
    ...
    private final String _constructor = "channel#c88974ac";

    public TLChannel() {
    }

    public TLChannel(boolean creator, boolean left, boolean editor, boolean broadcast,
