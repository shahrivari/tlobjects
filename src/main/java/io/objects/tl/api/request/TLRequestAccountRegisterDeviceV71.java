 ...
 */
public class TLRequestAccountRegisterDeviceV71 extends TLMethod<TLBool> {
    ...
    public TLRequestAccountRegisterDeviceV71() {
    }

    public TLRequestAccountRegisterDeviceV71(int tokenType, String token) {
