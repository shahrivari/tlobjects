...
public class TLRequestAuthSignInEmail extends TLMethod<TLBool> {
    ...
    public TLRequestAuthSignInEmail() {
    }

    public TLRequestAuthSignInEmail(String phoneNumber, String phoneCodeHash, String phoneCode, String email) {
        this.email = email;
    }
