 ...
 */
public class TLRequestMessagesEditMessageVtd extends TLMethod<TLAbsUpdates> {
    public static final int CONSTRUCTOR_ID = 0xd116f31e;
    ...
    private final String _constructor = "messages.editMessageVtd#d116f31e";

    public TLRequestMessagesEditMessageVtd() {
    }

    public TLRequestMessagesEditMessageVtd(boolean noWebpage, boolean stopGeoLive, TLAbsInputPeer peer,
