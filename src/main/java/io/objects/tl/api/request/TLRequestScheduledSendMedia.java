...
public class TLRequestScheduledSendMedia extends TLMethod<TLBool> {
    ...
    private final String _constructor = "scheduled.sendMedia#280e14f4";

    public TLRequestScheduledSendMedia() {
    }

    public TLRequestScheduledSendMedia(boolean silent, boolean background, boolean clearDraft,
    ...
    private void computeFlags() {
        ...
        flags = replyMarkup != null ? (flags | 16) : (flags & ~16);
        flags = entities != null ? (flags | 32) : (flags & ~32);
    }
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        replyMarkup = (flags & 16) != 0 ? readTLObject(stream, context, TLAbsReplyMarkup.class, -1) : null;
        entities = (flags & 32) != 0 ? readTLVector(stream, context) : null;
        time = readInt(stream);
    }
