 ...
 */
public class TLRequestMonobotSetBotCallbackAnswer extends TLMethod<TLBotUpdates> {
    public static final int CONSTRUCTOR_ID = 0xd56a714e;
    ...
    private final String _constructor = "monobot.setBotCallbackAnswer#d56a714e";

    public TLRequestMonobotSetBotCallbackAnswer() {
    }

    public TLRequestMonobotSetBotCallbackAnswer(boolean alert, long queryId, String message,
            String url, int cacheTime, long requestId, int botId) {
        this.alert = alert;
