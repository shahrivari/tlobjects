 ...
 */
public class TLRequestMonobotStickersRemoveStickerFromSet extends TLMethod<TLBotStickerSet> {
    public static final int CONSTRUCTOR_ID = 0xf76e200f;
    ...
    private final String _constructor = "monobot.stickersRemoveStickerFromSet#f76e200f";

    public TLRequestMonobotStickersRemoveStickerFromSet() {
    }

    public TLRequestMonobotStickersRemoveStickerFromSet(TLAbsInputDocument sticker, long requestId,
            int botId) {
