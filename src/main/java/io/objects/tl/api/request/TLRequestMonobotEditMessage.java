 ...
 */
public class TLRequestMonobotEditMessage extends TLMethod<TLBotUpdates> {
    public static final int CONSTRUCTOR_ID = 0xc115801c;
    ...
    private final String _constructor = "monobot.editMessage#c115801c";

    public TLRequestMonobotEditMessage() {
    }

    public TLRequestMonobotEditMessage(boolean noWebpage, boolean stopGeoLive, TLAbsInputPeer peer,
