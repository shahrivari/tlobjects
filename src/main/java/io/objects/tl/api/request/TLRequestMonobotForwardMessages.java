 ...
 */
public class TLRequestMonobotForwardMessages extends TLMethod<TLBotUpdates> {
    public static final int CONSTRUCTOR_ID = 0x3ba03395;
    ...
    private final String _constructor = "monobot.forwardMessages#3ba03395";

    public TLRequestMonobotForwardMessages() {
    }

    public TLRequestMonobotForwardMessages(boolean silent, boolean background, boolean withMyScore,
            boolean grouped, TLAbsInputPeer fromPeer, TLIntVector id, TLLongVector randomId,
            TLAbsInputPeer toPeer, long requestId, int botId) {
        this.silent = silent;
