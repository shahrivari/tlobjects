...
public class TLDecryptedMessageMediaExternalDocument extends TLAbsDecryptedMessageMedia {
    public static final int CONSTRUCTOR_ID = 0xfa95b0dd;
    ...
    private final String _constructor = "decryptedMessageMediaExternalDocument#fa95b0dd";

    public TLDecryptedMessageMediaExternalDocument() {
    }

    public TLDecryptedMessageMediaExternalDocument(long id, long accessHash, int date,
            String mimeType, int size, TLAbsPhotoSize thumb, int dcId,
