 ...
 */
public class TLChannelVtd extends TLAbsChat {
    public static final int CONSTRUCTOR_ID = 0x4df30834;
    ...
    protected TLChannelBannedRights defaultBannedRights;

    protected Integer participantsCount;

    private final String _constructor = "channelVtd#4df30834";

    public TLChannelVtd() {
    }

    public TLChannelVtd(boolean creator, boolean left, boolean broadcast,
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        adminRights = (flags & 16384) != 0 ? (TLChannelAdminRights) readTLObject(stream, context) : null;
