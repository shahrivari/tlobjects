 ...
 */
public class TLDecryptedMessageActionDeleteMessages extends TLAbsDecryptedMessageAction {
    public static final int CONSTRUCTOR_ID = 0x65614304;

    protected TLLongVector randomIds;

    private final String _constructor = "decryptedMessageActionDeleteMessages#65614304";

    public TLDecryptedMessageActionDeleteMessages() {
    }

    public TLDecryptedMessageActionDeleteMessages(TLLongVector randomIds) {
