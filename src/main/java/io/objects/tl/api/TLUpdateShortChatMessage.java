...
public class TLUpdateShortChatMessage extends TLAbsUpdates {
    ...
    public TLUpdateShortChatMessage(boolean out, boolean mentioned, boolean mediaUnread,
            boolean silent, int id, int fromId, int chatId, String message, int pts, int ptsCount,
            int date, TLMessageFwdHeader fwdFrom, Integer viaBotId, Integer replyToMsgId,
