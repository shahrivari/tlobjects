 ...
 */
public class TLBotPhotos extends TLAbsBotPhotos {
    public static final int CONSTRUCTOR_ID = 0x8e16c233;

    private final String _constructor = "monobot.botPhotos#8e16c233";

    public TLBotPhotos() {
    }

    public TLBotPhotos(TLVector<TLAbsPhoto> photos, TLVector<TLAbsUser> users, long requestId,
