 ...
 */
public class TLDocumentVtd extends TLAbsDocument {
    ...
    protected TLVector<TLAbsPhotoSize> thumb;

    protected int dcId;

    protected TLVector<TLAbsDocumentAttribute> attributes;

    private final String _constructor = "documentVtd#9ba29cc1";

    public TLDocumentVtd() {
    }

    public TLDocumentVtd(long id, long accessHash, TLBytes fileReference, int date, String mimeType,
                         int size, TLVector<TLAbsPhotoSize> thumb, int dcId, TLVector<TLAbsDocumentAttribute> attributes) {
        this.id = id;
...
//        writeInt(dcId, stream);
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        size = readInt(stream);
        thumb = readTLObject(stream, context, TLVector.class, -1);
        dcId = readInt(stream);
        dcId = 2;
    ...
    public TLVector<TLAbsPhotoSize> getThumb() {
        return thumb;
    }

    public void setThumb(TLVector<TLAbsPhotoSize> thumb) {
        this.thumb = thumb;
    }
