...
public class MTDestroySessionNone extends MTAbsDestroySessionResponse {
    public static final int CONSTRUCTOR_ID = 0xe7572126;

    private final String _constructor = "destroySessionNone#e7572126";

    public MTDestroySessionNone() {
    }

    public MTDestroySessionNone(long sessionId) {
