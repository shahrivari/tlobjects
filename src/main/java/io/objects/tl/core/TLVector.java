 ...
 * For working with primitive internal types you might instantiate class TLIntVector,
 * TLStringVector, TLLongVector for vector of integer, strings or long.
 *
...
public class TLVector<T> extends TLObject implements List<T> {
    ...
    public TLVector<T> fill(T... elements) {
