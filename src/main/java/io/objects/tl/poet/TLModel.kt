...
// Main definition
class TLDefinition(val types: Map<String, TLType>,
...
class TLConstructor(val name: String,
                    val id: Int,
                    val parameters: ArrayList<TLParameter>,
                    val tlType: TLTypeRaw) : Comparable<TLConstructor> {
...
class TLAbstractConstructor(val name: String,
                            val parameters: List<TLParameter>,
                            val tlType: TLTypeRaw,
                            val abstractEmptyConstructor: Boolean) : Comparable<TLAbstractConstructor> {
...
class TLMethod(val name: String,
               val id: Int,
               val parameters: List<TLParameter>,
               val tlType: TLType) : Comparable<TLMethod> {
...
class TLParameter(val name: String, val tlType: TLType) : Comparable<TLParameter> {
    ...
    override fun equals(other: Any?) =
            other is TLParameter && other.name == name && other.tlType == tlType
