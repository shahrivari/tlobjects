...
import io.tlobjects.tl.api.TLLangPackDifference;
...
public class TLRequestLangpackGetDifference extends TLMethod<TLLangPackDifference> {
    ...
    private final String _constructor = "langpack.getDifference#b2e4d7d";

    public TLRequestLangpackGetDifference() {
    }

    public TLRequestLangpackGetDifference(int fromVersion) {
