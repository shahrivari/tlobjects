...
public class TLRequestScheduledSendMultiMedia extends TLMethod<TLBool> {
    ...
    protected TLRequestMessagesSendMultiMedia message;
    protected int time;

    private final String _constructor = "users.getUsers#0B9E1D5A";

    public TLRequestScheduledSendMultiMedia() {
    }

    public TLRequestScheduledSendMultiMedia(TLRequestMessagesSendMultiMedia message, int time) {
    ...
    public void deserializeBody(InputStream stream, TLContext context) throws IOException {
        ...
        if (messageObject instanceof TLRequestMessagesSendMultiMedia)
            message = (TLRequestMessagesSendMultiMedia) messageObject;
        else
            throw new IllegalArgumentException(
                    "Message not instance of TLRequestScheduledSendMultiMedia");
        time = readInt(stream);
    }
    ...
    public TLRequestMessagesSendMultiMedia getMessage() {
        return message;
    }

    public void setMessage(TLRequestMessagesSendMultiMedia message) {
        this.message = message;
    }
