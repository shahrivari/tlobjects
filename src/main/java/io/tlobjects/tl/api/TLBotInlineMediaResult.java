...
public class TLBotInlineMediaResult extends TLAbsBotInlineResult {
    ...
    public TLBotInlineMediaResult(String id, String type, TLAbsPhoto photo, TLAbsDocument document,
            String title, String description, TLAbsBotInlineMessage sendMessage) {
        this.id = id;
        this.type = type;
        this.photo = photo;
