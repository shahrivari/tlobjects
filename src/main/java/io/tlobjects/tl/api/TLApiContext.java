...
import io.tlobjects.tl.mtproto.MTDestroySession;
import io.tlobjects.tl.mtproto.MTRpcAnswerUnknown;
import io.tlobjects.tl.api.help.*;
import io.tlobjects.tl.mtproto.MTRpcDropAnswer;
...
import io.tlobjects.tl.api.auth.TLCheckedPhone;
import io.tlobjects.tl.api.auth.TLCodeTypeCall;
import io.tlobjects.tl.api.auth.TLCodeTypeFlashCall;
import io.tlobjects.tl.api.auth.TLCodeTypeSms;
...
import io.tlobjects.tl.api.auth.TLSentCodeTypeApp;
import io.tlobjects.tl.api.auth.TLSentCodeTypeCall;
import io.tlobjects.tl.api.auth.TLSentCodeTypeFlashCall;
import io.tlobjects.tl.api.auth.TLSentCodeTypeSms;
import io.tlobjects.tl.api.channels.TLAdminLogResults;
import io.tlobjects.tl.api.channels.TLChannelParticipants;
import io.tlobjects.tl.api.channels.TLChannelParticipantsNotModified;
import io.tlobjects.tl.api.contacts.TLBlocked;
import io.tlobjects.tl.api.contacts.TLBlockedSlice;
import io.tlobjects.tl.api.contacts.TLContacts;
import io.tlobjects.tl.api.contacts.TLContactsNotModified;
...
import io.tlobjects.tl.api.contacts.TLTopPeers;
import io.tlobjects.tl.api.contacts.TLTopPeersDisabled;
import io.tlobjects.tl.api.contacts.TLTopPeersNotModified;
import io.tlobjects.tl.api.messages.TLAffectedHistory;
import io.tlobjects.tl.api.messages.TLAffectedMessages;
import io.tlobjects.tl.api.messages.TLAllStickers;
import io.tlobjects.tl.api.messages.TLAllStickersNotModified;
...
import io.tlobjects.tl.api.messages.TLChannelMessages;
import io.tlobjects.tl.api.messages.TLChats;
import io.tlobjects.tl.api.messages.TLChatsSlice;
import io.tlobjects.tl.api.messages.TLDhConfig;
import io.tlobjects.tl.api.messages.TLDhConfigNotModified;
import io.tlobjects.tl.api.messages.TLDialogs;
import io.tlobjects.tl.api.messages.TLDialogsNotModified;
import io.tlobjects.tl.api.messages.TLDialogsSlice;
import io.tlobjects.tl.api.messages.TLFavedStickers;
import io.tlobjects.tl.api.messages.TLFavedStickersNotModified;
import io.tlobjects.tl.api.messages.TLFeaturedStickers;
import io.tlobjects.tl.api.messages.TLFeaturedStickersNotModified;
import io.tlobjects.tl.api.messages.TLFoundGifs;
import io.tlobjects.tl.api.messages.TLFoundStickerSets;
import io.tlobjects.tl.api.messages.TLFoundStickerSetsNotModified;
import io.tlobjects.tl.api.messages.TLHighScores;
import io.tlobjects.tl.api.messages.TLMessageEditData;
import io.tlobjects.tl.api.messages.TLMessages;
import io.tlobjects.tl.api.messages.TLMessagesNotModified;
import io.tlobjects.tl.api.messages.TLMessagesSlice;
import io.tlobjects.tl.api.messages.TLPeerDialogs;
import io.tlobjects.tl.api.messages.TLRecentStickers;
import io.tlobjects.tl.api.messages.TLRecentStickersNotModified;
import io.tlobjects.tl.api.messages.TLSavedGifs;
import io.tlobjects.tl.api.messages.TLSavedGifsNotModified;
import io.tlobjects.tl.api.messages.TLSentEncryptedFile;
import io.tlobjects.tl.api.messages.TLSentEncryptedMessage;
import io.tlobjects.tl.api.messages.TLStickerSetInstallResultArchive;
import io.tlobjects.tl.api.messages.TLStickerSetInstallResultSuccess;
import io.tlobjects.tl.api.messages.TLStickers;
import io.tlobjects.tl.api.messages.TLStickersNotModified;
import io.tlobjects.tl.api.payments.TLPaymentForm;
import io.tlobjects.tl.api.payments.TLPaymentReceipt;
import io.tlobjects.tl.api.payments.TLPaymentResult;
import io.tlobjects.tl.api.payments.TLPaymentVerficationNeeded;
import io.tlobjects.tl.api.payments.TLSavedInfo;
import io.tlobjects.tl.api.payments.TLValidatedRequestedInfo;
import io.tlobjects.tl.api.photos.TLPhotos;
import io.tlobjects.tl.api.photos.TLPhotosSlice;
import io.tlobjects.tl.api.request.*;
import io.tlobjects.tl.api.storage.TLFileGif;
import io.tlobjects.tl.api.storage.TLFileJpeg;
import io.tlobjects.tl.api.storage.TLFileMov;
import io.tlobjects.tl.api.storage.TLFileMp3;
import io.tlobjects.tl.api.storage.TLFileMp4;
import io.tlobjects.tl.api.storage.TLFilePartial;
import io.tlobjects.tl.api.storage.TLFilePdf;
import io.tlobjects.tl.api.storage.TLFilePng;
import io.tlobjects.tl.api.storage.TLFileUnknown;
import io.tlobjects.tl.api.storage.TLFileWebp;
import io.tlobjects.tl.api.updates.TLChannelDifference;
import io.tlobjects.tl.api.updates.TLChannelDifferenceEmpty;
import io.tlobjects.tl.api.updates.TLChannelDifferenceTooLong;
import io.tlobjects.tl.api.updates.TLDifference;
import io.tlobjects.tl.api.updates.TLDifferenceEmpty;
import io.tlobjects.tl.api.updates.TLDifferenceSlice;
import io.tlobjects.tl.api.updates.TLDifferenceTooLong;
import io.tlobjects.tl.api.updates.TLState;
import io.tlobjects.tl.api.upload.TLCdnFile;
import io.tlobjects.tl.api.upload.TLCdnFileReuploadNeeded;
import io.tlobjects.tl.api.upload.TLFile;
import io.tlobjects.tl.api.upload.TLFileCdnRedirect;
...
public class TLApiContext extends TLContext {
    ...
    public void init() {
        ...
        registerClass(io.tlobjects.tl.api.auth.TLAuthorization.CONSTRUCTOR_ID, io.tlobjects.tl.api.auth.TLAuthorization.class);
        ...
        registerClass(io.tlobjects.tl.api.channels.TLChannelParticipant.CONSTRUCTOR_ID, io.tlobjects.tl.api.channels.TLChannelParticipant.class);
        ...
        registerClass(io.tlobjects.tl.api.messages.TLChatFull.CONSTRUCTOR_ID, io.tlobjects.tl.api.messages.TLChatFull.class);
        ...
        registerClass(io.tlobjects.tl.api.messages.TLStickerSet.CONSTRUCTOR_ID, io.tlobjects.tl.api.messages.TLStickerSet.class);
        ...
        registerClass(io.tlobjects.tl.api.phone.TLPhoneCall.CONSTRUCTOR_ID, io.tlobjects.tl.api.phone.TLPhoneCall.class);
        ...
        registerClass(io.tlobjects.tl.api.photos.TLPhoto.CONSTRUCTOR_ID, io.tlobjects.tl.api.photos.TLPhoto.class);
        ...
        registerClass(io.tlobjects.tl.api.request.TLRequestAccountRegisterDevice.CONSTRUCTOR_ID, io.tlobjects.tl.api.request.TLRequestAccountRegisterDevice.class);
